...
def build_matryoshka_batchtopk_sae_training_cfg(
    **kwargs,
    ...
    matryoshka_widths = kwargs.pop("matryoshka_widths", [])
    base_cfg = build_batchtopk_sae_training_cfg(**kwargs)
    cfg_dict = base_cfg.to_dict()
    cfg_dict["architecture"] = "matryoshka_batchtopk"
    cfg_dict["matryoshka_widths"] = matryoshka_widths
    return MatryoshkaBatchTopKTrainingSAEConfig.from_dict(cfg_dict)
