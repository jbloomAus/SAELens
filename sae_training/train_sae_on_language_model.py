...
def train_sae_on_language_model(
    ...
    optimizers = [
        Adam(sae.parameters(), lr=sparse_autoencoder.cfg.lr)
        for sae, hyperparams in sparse_autoencoders
    ]
    schedulers = [
        get_scheduler(
    ...
    while n_training_tokens < total_training_tokens:
        ...
        for (sparse_autoencoder, hyperparams), in zip(sparse_autoencoders, ):
